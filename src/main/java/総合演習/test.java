...
// リストをすべて削除すると追加まわりでエラー発生。arrayNextの書き換えに原因あり？
    /* 削除を行うメソッド */
    private void deleteFromList(int num) {
        ...
        if(prevIdx == END_OF_LIST){
            ...
            if (arrayNum[prevIdx] != num){
                ...
                arrayNext[eip] = prevIdx;
                lip = arrayNext[prevIdx];
                arrayNext[prevIdx] = END_OF_LIST;
...
//System.out.println("lip=" + lip + "eip=" + eip);